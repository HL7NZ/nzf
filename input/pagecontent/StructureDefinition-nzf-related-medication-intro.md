...
<p>For those familiar with the NZMT table structure, these are only the direct links between concepts with the exception being that the THT and MHM tables are not used (the links are added directly)</p>