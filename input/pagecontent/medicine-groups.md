...
**nzmtid**: FHIR [Coding](https://hl7.org/fhir/R4B/datatypes.html#Coding) - one or more NZMT Codes (with system `http://nzmt.org.nz`) from any of the following concepts (MP, TP, MPP, TPP, MPUU, TPUU or CTPP)
