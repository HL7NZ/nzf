...
Where the attribute = ‘PSO’, each applicable medicine has an additional text ‘Up to [value] [units] available on a [attribute]’.

Where the attribute = ‘Rx’, each applicable medicine has an additional text ‘Maximum of [value] [units] per prescription’.
