...
The aim of this page is to detail all the available data items available.  For each there should be a brief description of the data along with details on how it be retrieved and used.  Most of these apply to medication resources but some also use other FHIR resource type (Substance, DocumentReference).  
...
- ruleAttribute: [TODO]
- ruleValue: [TODO]
- ruleText: This is a derived text based on the rule details.  For example: 
- ruleAdditionalData:  This is a piece of XML which is provided by pharmac - this for example can contain the MathML for Special Authority forms.
- ruleWaiver:  [TODO]
- ruleXlinkHref: [TODO]
...
<table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td>Not on a [ps_rule.attribute].</td>
            </tr>
            <tr>
                <td>Community</td>
                <td>FormMax</td>
                ...
                <td></td>
                <td>
                    Up to [ps_rule.value] [ps_formulation.units] available on a PSO.
                </td>
            </tr>
            <tr>
                <td>Community</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    Safety cap required for extemporaneously compounded oral liquid preparations
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    Statim: Three months or six months, as applicable, dispensed all-at-once.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    Statim: Three months supply may be dispensed at one time if endorsed 'certified exemption' by the
                    prescriber.
                </td>
            </tr>
            <tr>
                ...
                <td></td>
                <td>
                    Safety medicine; prescriber may determine dispensing frequency
                </td>
            </tr>
            <tr>
                <td>Community</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    Maximum of [ps_rule.value] [ps_formulation.units] per prescription.
                </td>
            </tr>
            <tr>
                <td>Community</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    No more than [ps_rule.value] [ps_formulation.units] per dose.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    No more than [ps_rule.value] mg per dose.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    No more than [ps_rule.value] [ps_formulation.units] per week.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    No more than [ps_rule.value] mg per week.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    The maximum quantity ordered on a PSO for providers in the Rheumatic Fever Prevention Programme (RFPP) may be up to [ps_rule.value] times the maximum quantity . The PSO must specify the order quantity in course-specific amounts to enable the pharmacy to dispense each course separately.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    Eligible for a subsidy on prescription of a Pharmacist
                </td>
            </tr>
            <tr>
                <td>Community</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    Maximum patient co-payment payable: [ps_rule.value]
                </td>
            </tr>
            <tr>
                <td>Community</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    Pharmaceutical Cancer Treatment only.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    Maximum of [ps_rule.value] days treatment per prescription.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    Additional subsidy by Special Authority
                </td>
            </tr>
            <tr>
                <td>Community</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    Higher subsidy with Special Authority.
                </td>
            </tr>
            <tr>
                <td>Community</td>
            ...
            <tr>
                <td>Community</td>
                <td>Special</td>
                <td>[ps_rule.xlink_href]</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                <td>
                    Can be waived by Special Authority.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td></td>
                <td>Can be waived by endorsement.</td>
            </tr>
            <tr>
                <td>Community</td>
                <td>SpecEnd</td>
            ...
            <tr>
                <td>Community</td>
                <td>SpecialAuthority</td>
                <td>[ps_request.sa_form]</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                <td>[ps_note.notes_xml]</td>
            </tr>
            <tr>
                <td>Community</td>
                <td>Combined</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    No more than [ps_rule.value] [ps_formulation.units] per day.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    No more than [ps_rule.value] mg per day.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    No more than [ps_rule.value] [ps_formulation.units] per month.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    No more than [ps_rule.value] mg per month.
                </td>
            </tr>
            <tr>
                <td>Community</td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    Maximum of [ps_rule.value] mg per prescription.
                </td>
            </tr>
            <tr>
                <td>Community</td>
                ...
                <td></td>
                <td>
                    Maximum of [ps_rule.value] mg per PSO.
                </td>
            </tr>
            <tr>
                <td>HML</td>
